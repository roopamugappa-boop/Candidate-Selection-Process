...
def render_question(user_id, question_idx, last_code="", dhan_client_id=None, dhan_access_token=None, time_left=None):
    ...
    header_html = (
        '<div style="text-align:center;margin-top:24px;margin-bottom:4px;font-family:Segoe UI,Arial,sans-serif;">'
    ...
    qbar_timer_html = (
        ...
        f'Question {question_idx + 1} of {total}'
        f'</span>'
        f'</div>'
    ...
    <head>
        ...
        <style>
            ...
            .main-exam-flex {{
                width: 99vw; display: flex; flex-direction: column; justify-content: flex-start; align-items: center;
            }}
            .exam-content-outer {{
                flex:1 1 auto; display: flex; flex-direction:column; align-items:center; width:99vw;
            ...
            .exam-box {{
                ...
                width: 99vw; max-width: 1160px; box-sizing: border-box; margin: 23px auto 0 auto;
            ...
            #result {{
                ...
                white-space: pre-wrap; min-height: 10px; height: 100%; max-height: none;
                overflow-y: auto; overflow-x: auto; margin-top: 6px; margin-bottom: 0;
                box-sizing: border-box; display: block;
                box-shadow:0 2px 7px #becaea;
                flex: 1 1 auto;
            }}
            #result::-webkit-scrollbar {{ width: 8px; background: #333; }}
            #result::-webkit-scrollbar-thumb {{ background: #444; border-radius: 6px; }}
            .buttons-row-new {{
                width: 100%; display: flex; flex-direction: row; gap:15px; align-items:center; margin-top:7px; margin-bottom:0.15em;
                flex-wrap:nowrap; justify-content: flex-start;
            }}
            .note-bar {{
                margin-top:14px; color:#963500; font-size:1.03em;
                background:linear-gradient(90deg,#fff9ea 0%,#ffe6d7 100%);
                border:1.1px solid #fad395; border-radius:7px; padding:8px 15px;
                box-shadow:0 0.7px 2px #f0dcc1; font-weight:500;
                text-align:left;
            }}
            @media (max-width:1200px) {{
                .exam-box, .qnav-timer-horizontal {{ max-width:99vw !important; }}
                .exam-layout-split {{ flex-direction: column; gap: 18px; }}
                .exam-layout-left, .exam-layout-right {{ max-width:99vw; min-width:160px; width:100%; }}
                .exam-layout-right {{
                    height: auto;
                }}
            }}
            @media (max-width:700px) {{
                .qnav-timer-horizontal {{
                    ...
                    padding: 4.4vw 1vw 4vw 1vw;
                }}
                .exam-box {{
                    padding:4vw 2vw 2vw 2vw;
                    min-width: 0;
                }}
                .panel-question-content, .panel-output-content {{ max-height: 48px; font-size:0.97em; }}
                .exam-layout-right {{
                    height: auto;
                }}
                .editor-slice, .terminal-slice {{
                    flex: none;
                }}
                #code {{ height: 64px; min-height: 44px; max-height: 130px; font-size:0.98em; }}
                #result {{ min-height: 10px; height: auto; max-height: 28px; font-size:0.89em; }}
                .buttons-row-new {{
                    flex-direction: column;
                    align-items: stretch;
                    gap:8px;
            ...
            <div class="main-exam-flex">
                <div class="exam-content-outer">
                    <div class="exam-box">
                        ...
                        <div class="note-bar">
                            <b>Note:</b> Please use the <em>“Skip”</em> option if you prefer not to answer this question. Once skipped, you will not be able to revisit this question during this exam session.
                        </div>
                    </div>
                </div>
            </div>
